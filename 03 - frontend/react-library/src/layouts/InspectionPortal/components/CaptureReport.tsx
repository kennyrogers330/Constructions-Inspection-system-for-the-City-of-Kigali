...
export const CaptureReport: React.FC<{projectId: string}> = (props) =>{
    ...
    const report_redirect2 = (percentageProgress: number, formData: FormData) => {
        const modelAttributes = {
            ...
            PavementCondition: formData.get("PavementCondition"),
            RoadMarkings: formData.get("RoadMarkings"),
            RoadsideVegetation: formData.get("RoadsideVegetation"),
            DrainageSystem: formData.get("DrainageSystem"),
            CracksandPotholes: formData.get("CracksandPotholes"),
            SurfaceSmoothness: formData.get("SurfaceSmoothness"),
            Rutting: formData.get("Rutting"),
            EdgeCondition: formData.get("EdgeCondition"),
            ExcavationCompletion: formData.get("ExcavationCompletion"),
            FoundationStability: formData.get("FoundationStability"),
            MaterialQuality: formData.get("MaterialQuality"),
            EquipmentUtilization: formData.get("EquipmentUtilization"),
            WorkforceProductivity: formData.get("WorkforceProductivity"),
            WaterSupply: formData.get("WaterSupply"),
            BedRocks: formData.get("BedRocks"),
            ClimateFavorability: formData.get("ClimateFavorability"),
        ...
        const url = `http://localhost:8080/api/admin/secure/add/report`;
            ...
            if(authState?.isAuthenticated 
               ...
               // console.log(recipients);
                ...
                formData.append("PavementCondition", PavementCondition);
                formData.append("RoadMarkings", RoadMarkings);
                formData.append("RoadsideVegetation", RoadsideVegetation);
                formData.append("DrainageSystem", DrainageSystem);
                formData.append("CracksandPotholes", CracksandPotholes);
                formData.append("SurfaceSmoothness", SurfaceSmoothness);
                formData.append("Rutting", Rutting);
                formData.append("EdgeCondition", EdgeCondition);
                formData.append("ExcavationCompletion", ExcavationCompletion);
                formData.append("FoundationStability", FoundationStability);
                formData.append("MaterialQuality", MaterialQuality);
                formData.append("EquipmentUtilization", EquipmentUtilization);
                formData.append("WorkforceProductivity", WorkforceProductivity);
                formData.append("WaterSupply", WaterSupply);
                formData.append("BedRocks", BedRocks);
                formData.append("ClimateFavorability", ClimateFavorability);

                formData.append("pavementConditionWeight", pavementConditionWeight+'');
                formData.append("RoadMarkingsWeight", RoadMarkingsWeight+'');
                formData.append("RoadsideVegetationWeight", RoadsideVegetationWeight+'');
                formData.append("DrainageSystemWeight", DrainageSystemWeight+'');
                formData.append("CracksandPotholesWeight", CracksandPotholesWeight+'');
                formData.append("SurfaceSmoothnessWeight", SurfaceSmoothnessWeight+'');
                formData.append("RuttingWeight", RuttingWeight+'');
                formData.append("EdgeConditionWeight", EdgeConditionWeight+'');
                formData.append("ExcavationCompletionWeight", ExcavationCompletionWeight+'');
                formData.append("FoundationStabilityWeight", FoundationStabilityWeight+'');
                formData.append("MaterialQualityWeight", MaterialQualityWeight+'');
                formData.append("EquipmentUtilizationWeight", EquipmentUtilizationWeight+'');
                formData.append("WorkforceProductivityWeight", WorkforceProductivityWeight+'');
                formData.append("WaterSupplyWeight", WaterSupplyWeight+'');
                formData.append("BedRocksWeight", BedRocksWeight+'');
                formData.append("ClimateFavorabilityWeight", ClimateFavorabilityWeight+'');
            ...
            <div className="card-body">
                <form method="POST" id="formElem" encType="multipart/form-data">
                        ...
                        {projectType==='road' &&
                            <>
                        <div className="row mt-5">
                            <h3 className="text-primary">Phase 1: Site Preparation</h3> 
